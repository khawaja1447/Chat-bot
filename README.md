...
|---|---|---|---|---|
| Dense only (FAISS + MiniLM) | 0.661 | 0.927 | 0.774 | 7 ms |
| \+ BM25 hybrid (RRF) | 0.743 | 0.972 | 0.844 | 7 ms |
| **\+ cross-encoder rerank** | **0.927** | **0.991** | **0.958** | 102 ms |

**Recall@1 +40%, MRR +24%** over the dense baseline, for about 95 ms.
